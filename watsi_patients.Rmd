...
This is an analysis of patient data from watsi.org. The link to dataset is : [Watsi data](https://docs.google.com/spreadsheets/d/1tZq47h6jg7NX4ddhTS_H8JFVfLZiDbxwwdQD47_ow64/edit "Watsi dataset")
...
Number of days it took to fund patients. Using the "Date.Posted" and "Date.Funded" we can caluculate the number of days it took to fund each patient, we call this column "numDaysFunded". Let us take a look at how "numDaysFunded" changes for various factors. 
