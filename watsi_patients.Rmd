...
2. Number of days it took to fund patients, this is important factor, the shorter the better for watsi and patient's health outcome. We explore the same by seasonality (month of the year).
...
There are a couple of parameters that are still being processed - gender, adult/child. These extra parameters will be interesting to explore. Collecting gender data is straightforward, counting pronouns from the profiles give an easy way to accurately estimate gender. Gender data can answer questions if in the data set, people are more likely to be more philanthropic towards a particular gender.
